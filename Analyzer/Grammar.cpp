...
const char *SymbolNames[27] = {
    "program",    "arglist",     "compound_stmt",  "condition",
    "const_decl", "const_item",  "decl_trailer",   "declaration",
    "expr",       "factor",      "factor_trailer", "flow_stmt",
    "for_stmt",   "if_stmt",     "integer",        "paralist",
    "read_stmt",  "return_stmt", "stmt",           "stmt_trailer",
    "subscript2", "term",        "type_name",      "var_decl",
    "var_item",   "while_stmt",  "write_stmt"};

static Label labels[63] = {
    {0, "EMPTY"}, {3, 0},        {260, 0},      {263, 0},     {0, "char"},
    {0, "const"}, {0, "int"},    {0, "void"},   {1, "("},     {264, 0},
    {1, ")"},     {1, ","},      {1, "{"},      {1, "}"},     {274, 0},
    {279, 0},     {1, "!="},     {1, "<"},      {1, "<="},    {1, "=="},
    {1, ">"},     {1, ">="},     {1, "+"},      {1, "-"},     {4, 0},
    {0, 0},       {5, 0},        {278, 0},      {261, 0},     {1, ";"},
    {1, "="},     {270, 0},      {258, 0},      {271, 0},     {276, 0},
    {280, 0},     {1, "["},      {0, "main"},   {262, 0},     {277, 0},
    {266, 0},     {257, 0},      {1, "]"},      {268, 0},     {269, 0},
    {272, 0},     {273, 0},      {281, 0},      {282, 0},     {0, "for"},
    {0, "if"},    {0, "printf"}, {0, "return"}, {0, "scanf"}, {0, "while"},
    {259, 0},     {0, "else"},   {267, 0},      {275, 0},     {265, 0},
    {1, "*"},     {1, "/"},      {6, 0}};
...
static DFAState states_2[5] = {{1, arcs_2_0, 0},
                               {4, arcs_2_1, 0},
                               {1, arcs_2_2, 1},
                               {2, arcs_2_3, 0},
                               {3, arcs_2_4, 0}};

static DFA dfa_2 = {"compound_stmt", 5, states_2, 1, first_2};

static Arc arcs_3_0[1] = {{9, 1}};

static Arc arcs_3_1[7] = {{16, 2}, {17, 2}, {18, 2}, {19, 2},
                          {20, 2}, {21, 2}, {0, 1}};
...
static DFAState states_3[4] = {
    {1, arcs_3_0, 0}, {7, arcs_3_1, 1}, {1, arcs_3_2, 0}, {1, arcs_3_3, 1}};

static DFA dfa_3 = {"condition", 4, states_3, 6, first_3};
...
static DFA dfa_4 = {"const_decl", 5, states_4, 1, first_4};
...
static DFAState states_5[4] = {
    {1, arcs_5_0, 0}, {1, arcs_5_1, 0}, {2, arcs_5_2, 0}, {1, arcs_5_3, 1}};

static DFA dfa_5 = {"const_item", 4, states_5, 1, first_5};
...
static DFAState states_6[5] = {{5, arcs_6_0, 0},
                               {1, arcs_6_1, 0},
                               {1, arcs_6_2, 1},
                               {1, arcs_6_3, 0},
                               {2, arcs_6_4, 0}};

static DFA dfa_6 = {"decl_trailer", 5, states_6, 5, first_6};
...
static DFAState states_7[7] = {
    {1, arcs_7_0, 0}, {2, arcs_7_1, 0}, {1, arcs_7_2, 0}, {1, arcs_7_3, 0},
    {1, arcs_7_4, 0}, {1, arcs_7_5, 1}, {1, arcs_7_6, 0}};

static DFA dfa_7 = {"declaration", 7, states_7, 3, first_7};
...
static DFAState states_8[3] = {
    {3, arcs_8_0, 0}, {1, arcs_8_1, 0}, {3, arcs_8_2, 1}};

static DFA dfa_8 = {"expr", 3, states_8, 6, first_8};
...
static DFAState states_9[5] = {{4, arcs_9_0, 0},
                               {1, arcs_9_1, 0},
                               {1, arcs_9_2, 1},
                               {2, arcs_9_3, 1},
                               {1, arcs_9_4, 0}};

static DFA dfa_9 = {"factor", 5, states_9, 4, first_9};
...
static DFAState states_10[4] = {
    {2, arcs_10_0, 0}, {1, arcs_10_1, 0}, {1, arcs_10_2, 1}, {1, arcs_10_3, 0}};

static DFA dfa_10 = {"factor_trailer", 4, states_10, 2, first_10};

static Arc arcs_11_0[6] = {{43, 1}, {44, 1}, {45, 2},
                           {46, 2}, {47, 1}, {48, 2}};
...
static DFAState states_11[3] = {
    {6, arcs_11_0, 0}, {1, arcs_11_1, 1}, {1, arcs_11_2, 0}};

static DFA dfa_11 = {"flow_stmt", 3, states_11, 6, first_11};
...
static DFAState states_12[16] = {
    {1, arcs_12_0, 0},  {1, arcs_12_1, 0},  {1, arcs_12_2, 0},
    {1, arcs_12_3, 0},  {1, arcs_12_4, 0},  {1, arcs_12_5, 0},
    {1, arcs_12_6, 0},  {1, arcs_12_7, 0},  {1, arcs_12_8, 0},
    {1, arcs_12_9, 0},  {1, arcs_12_10, 0}, {2, arcs_12_11, 0},
    {1, arcs_12_12, 0}, {1, arcs_12_13, 0}, {1, arcs_12_14, 0},
    {1, arcs_12_15, 1}};

static DFA dfa_12 = {"for_stmt", 16, states_12, 1, first_12};
...
static DFAState states_13[8] = {
    {1, arcs_13_0, 0}, {1, arcs_13_1, 0}, {1, arcs_13_2, 0}, {1, arcs_13_3, 0},
    {1, arcs_13_4, 0}, {2, arcs_13_5, 1}, {1, arcs_13_6, 0}, {1, arcs_13_7, 1}};

static DFA dfa_13 = {"if_stmt", 8, states_13, 1, first_13};
...
static DFAState states_14[3] = {
    {3, arcs_14_0, 0}, {1, arcs_14_1, 0}, {1, arcs_14_2, 1}};

static DFA dfa_14 = {"integer", 3, states_14, 3, first_14};
...
static DFAState states_15[5] = {{1, arcs_15_0, 0},
                                {1, arcs_15_1, 0},
                                {1, arcs_15_2, 0},
                                {2, arcs_15_3, 0},
                                {1, arcs_15_4, 1}};

static DFA dfa_15 = {"paralist", 5, states_15, 1, first_15};
...
static DFA dfa_16 = {"read_stmt", 5, states_16, 1, first_16};
...
static DFA dfa_17 = {"return_stmt", 5, states_17, 1, first_17};
...
static DFAState states_18[5] = {{4, arcs_18_0, 0},
                                {1, arcs_18_1, 1},
                                {2, arcs_18_2, 0},
                                {2, arcs_18_3, 0},
                                {1, arcs_18_4, 0}};

static DFA dfa_18 = {"stmt", 5, states_18, 9, first_18};
...
static DFAState states_19[6] = {{3, arcs_19_0, 0}, {1, arcs_19_1, 0},
                                {1, arcs_19_2, 0}, {1, arcs_19_3, 1},
                                {1, arcs_19_4, 0}, {1, arcs_19_5, 0}};

static DFA dfa_19 = {"stmt_trailer", 6, states_19, 3, first_19};
...
static DFAState states_20[4] = {
    {1, arcs_20_0, 0}, {1, arcs_20_1, 0}, {1, arcs_20_2, 0}, {1, arcs_20_3, 1}};

static DFA dfa_20 = {"subscript2", 4, states_20, 1, first_20};
...
static DFA dfa_21 = {"term", 2, states_21, 4, first_21};
...
static DFA dfa_22 = {"type_name", 2, states_22, 3, first_22};
...
static DFAState states_23[4] = {
    {1, arcs_23_0, 0}, {1, arcs_23_1, 0}, {2, arcs_23_2, 0}, {1, arcs_23_3, 1}};

static DFA dfa_23 = {"var_decl", 4, states_23, 3, first_23};
...
static DFAState states_24[3] = {
    {1, arcs_24_0, 0}, {2, arcs_24_1, 1}, {1, arcs_24_2, 1}};

static DFA dfa_24 = {"var_item", 3, states_24, 1, first_24};
...
static DFAState states_25[6] = {{1, arcs_25_0, 0}, {1, arcs_25_1, 0},
                                {1, arcs_25_2, 0}, {1, arcs_25_3, 0},
                                {1, arcs_25_4, 0}, {1, arcs_25_5, 1}};

static DFA dfa_25 = {"while_stmt", 6, states_25, 1, first_25};
...
static DFAState states_26[7] = {
    {1, arcs_26_0, 0}, {1, arcs_26_1, 0}, {2, arcs_26_2, 0}, {2, arcs_26_3, 0},
    {1, arcs_26_4, 0}, {1, arcs_26_5, 1}, {1, arcs_26_6, 0}};

static DFA dfa_26 = {"write_stmt", 7, states_26, 1, first_26};
