...
Location loc;;
    ...
    Decl(int subclass_tag, Location loc): AST(), subclass_tag(subclass_tag), loc(loc) {}
...
Location loc;;
    ...
    Stmt(int subclass_tag, Location loc): AST(), subclass_tag(subclass_tag), loc(loc) {}
...
Location loc;;
    ...
    Expr(int subclass_tag, Location loc): AST(), subclass_tag(subclass_tag), loc(loc) {}
...
Expr* value;
    ...
    ConstDecl(BasicTypeKind type, const std::string& name, Expr* value, Location loc):
...
std::vector<Stmt*> stmts;
    ...
    FuncDef(BasicTypeKind return_type, const std::string& name, const std::vector<Arg*>& args, const std::vector<Decl*>& decls, const std::vector<Stmt*>& stmts, Location loc):
        Decl(Decl::FuncDef, loc), return_type(return_type), name(name), args(args), decls(decls), stmts(stmts) {}
...
public:
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::Read;
    }
};
...
Expr* value;
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::Write;
    }
};
...
Expr* value;
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::Assign;
    }
};
...
std::vector<Stmt*> body;
    ...
    For(Stmt* initial, Expr* condition, Stmt* step, const std::vector<Stmt*>& body, Location loc):
        Stmt(Stmt::For, loc), initial(initial), condition(condition), step(step), body(body) {}
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::For;
    }
};
...
std::vector<Stmt*> body;
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::While;
    }
};
...
public:
    ...
    Return(Expr* value, Location loc):
    ...
    static bool InstanceCheck(Stmt *x) {
        return x->subclass_tag == Stmt::Return;
    }
};
...
std::vector<Stmt*> orelse;
    ...
    If(Expr* test, const std::vector<Stmt*>& body, const std::vector<Stmt*>& orelse, Location loc):
...
Expr* right;
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::BinOp;
    }
};
...
std::vector<Expr*> args;
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::Call;
    }
};
...
public:
    ...
    Num(int n, Location loc):
        Expr(Expr::Num, loc), n(n) {}
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::Num;
    }
};
...
public:
    ...
    Str(const std::string& s, Location loc):
        Expr(Expr::Str, loc), s(s) {}
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::Str;
    }
};
...
public:
    ...
    Char(int c, Location loc):
        Expr(Expr::Char, loc), c(c) {}
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::Char;
    }
};
...
ExprContextKind ctx;
    ...
    Subscript(const std::string& name, Expr* index, ExprContextKind ctx, Location loc):
...
ExprContextKind ctx;
    ...
    static bool InstanceCheck(Expr *x) {
        return x->subclass_tag == Expr::Name;
    }
};
...
Location loc;
    ...
    Arg(BasicTypeKind type, const std::string& name, Location loc): AST(), type(type), name(name), loc(loc) {}
...
int size;
    ...
    VarType(BasicTypeKind type, int is_array, int size): AST(), type(type), is_array(is_array), size(size) {}
